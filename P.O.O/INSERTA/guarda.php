...
$datosUsuario = new DatosUsuario($nombre, $edad);
	...
	<body>
		<div class="contenedor">
				<div class="font-titulo">
					<center>TUS DATOS</center></div>
					
		<div class="form-input minom">
            <label for="minom"><i>TU NOMBRE ES: </i><?php echo $datosUsuario->getNombre(); ?></label>
        </div>

        <div class="form-input ap">
            <label for="ap"><i>TU EDAD ES DE: </i><?php echo $datosUsuario->getEdad(); ?></label>
        </div>
