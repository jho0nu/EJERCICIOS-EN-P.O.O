...
$numero = $_POST['numero1'] ?? 0;

$analizador = new ParImpar($numero);
$resultado = $analizador->determinarParImpar();
...
<meta charset="utf-8">
 ...
 <div class="contenedor">
        ...
        <div class="form-input ap">
            <label for="ap"><i>EL NUMERO <?php echo $numero; ?> ES <?php echo $resultado; ?></i></label>
        </div>
